...
`},"@showid/true":function(e,t){if(!e.tmp.just_looking&&!e.tmp.suppress_decorations&&this.params&&typeof t=="string"){var i="";if(t){var r=t.match(a.VARIABLE_WRAPPER_PREPUNCT_REX);i=r[1],t=r[2]}var s="";return t&&a.SWAPPING_PUNCTUATION.indexOf(t.slice(-1))>-1&&(s=t.slice(-1),t=t.slice(0,-1)),e.sys.variableWrapper(this.params,i,t,s)}else return t},"@URL/true":function(e,t){return`<fo:basic-link external-destination="url('`+t+`')">`+t+"</fo:basic-link>"},"@DOI/true":function(e,t){var i=t;return t.match(/^https?:\/\//)||(i="https://doi.org/"+t),`<fo:basic-link external-destination="url('`+i+`')">`+t+"</fo:basic-link>"}};a.Output.Formats.prototype.latex={text_escape:function(e){return e||(e=""),e},bibstart:"\\begin{thebibliography}{4}",bibend:"\\end{thebibliography}","@font-style/italic":"{\\em %%STRING%%}","@font-style/oblique":!1,"@font-style/normal":!1,"@font-variant/small-caps":!1,"@passthrough/true":a.Output.Formatters.passthrough,"@font-variant/normal":!1,"@font-weight/bold":"{\\bf %%STRING%%}","@font-weight/normal":!1,"@font-weight/light":!1,"@text-decoration/none":!1,"@text-decoration/underline":!1,"@vertical-align/baseline":!1,"@vertical-align/sup":!1,"@vertical-align/sub":!1,"@strip-periods/true":a.Output.Formatters.passthrough,"@strip-periods/false":a.Output.Formatters.passthrough,"@quotes/true":function(e,t){return typeof t>"u"?e.getTerm("open-quote"):e.getTerm("open-quote")+t+e.getTerm("close-quote")},"@quotes/inner":function(e,t){return typeof t>"u"?"\u2019":e.getTerm("open-inner-quote")+t+e.getTerm("close-inner-quote")},"@quotes/false":!1,"@cite/entry":function(e,t){return e.sys.wrapCitationEntry(t,this.item_id,this.locator_txt,this.suffix_txt)},"@bibliography/entry":function(e,t){return"\\bibitem{"+e.sys.embedBibliographyEntry(this.item_id)+`}
`},"@display/block":function(e,t){return`
`+t},"@display/left-margin":function(e,t){return t},"@display/right-inline":function(e,t){return t},"@display/indent":function(e,t){return`
    `+t},"@showid/true":function(e,t,i){return t},"@URL/true":function(e,t){return t},"@DOI/true":function(e,t){return t}};a.Output.Formats=new a.Output.Formats;a.Registry=function(e){this.debug=!1,this.state=e,this.registry={},this.reflist=[],this.refhash={},this.namereg=new a.Registry.NameReg(e),this.citationreg=new a.Registry.CitationReg(e),this.authorstrings={},this.masterMap={},this.mylist=[],this.myhash={},this.deletes=[],this.inserts=[],this.uncited={},this.refreshes={},this.akeys={},this.oldseq={},this.return_data={},this.ambigcites={},this.ambigresets={},this.sorter=new a.Registry.Comparifier(e,"bibliography_sort"),this.getSortedIds=function(){for(var t=[],i=0,r=this.reflist.length;i<r;i+=1)t.push(""+this.reflist[i].id);return t},this.getSortedRegistryItems=function(){for(var t=[],i=0,r=this.reflist.length;i<r;i+=1)t.push(this.reflist[i]);return t}};a.Registry.prototype.init=function(e,t){var i,r;if(this.oldseq={},t){this.uncited={};for(var i=0,r=e.length;i<r;i+=1)this.myhash[e[i]]||this.mylist.push(""+e[i]),this.uncited[e[i]]=!0,this.myhash[e[i]]=!0}else{for(var s in this.uncited)e.push(s);var o={};for(i=e.length-1;i>-1;i+=-1)o[e[i]]?e=e.slice(0,i).concat(e.slice(i+1)):o[e[i]]=!0;this.mylist=e,this.myhash=o}this.refreshes={},this.touched={},this.ambigsTouched={},this.ambigresets={}};a.Registry.prototype.dopurge=function(e){for(var t=this.mylist.length-1;t>-1;t+=-1)this.citationreg.citationsByItemId&&(!this.citationreg.citationsByItemId||!this.citationreg.citationsByItemId[this.mylist[t]])&&!e[this.mylist[t]]&&(delete this.myhash[this.mylist[t]],delete this.uncited[this.mylist[t]],this.mylist=this.mylist.slice(0,t).concat(this.mylist.slice(t+1)));this.dodeletes(this.myhash)};a.Registry.prototype.dodeletes=function(e){var t,i,r,s,o,n,l,m,u;if(typeof e=="string"){var i=e;e={},e[i]=!0}for(var i in this.registry)if(!e[i]){if(this.uncited[i])continue;t=this.namereg.delitems(i);for(l in t)this.refreshes[l]=!0;for(r=this.registry[i].ambig,m=this.ambigcites[r].indexOf(i),m>-1&&(n=this.ambigcites[r].slice(),this.ambigcites[r]=n.slice(0,m).concat(n.slice(m+1,n.length)),this.ambigresets[r]=this.ambigcites[r].length),o=this.ambigcites[r].length,s=0;s<o;s+=1)u=""+this.ambigcites[r][s],this.refreshes[u]=!0;if(this.registry[i].siblings){if(this.registry[i].siblings.length==1){var p=this.registry[i].siblings[0];this.registry[p].siblings&&(this.registry[p].siblings.pop(),this.registry[p].master=!0)}else if(this.registry[i].siblings.length>1){var f=[i];if(this.registry[i].master){var c=this.registry[i].siblings[0],d=this.registry[c];d.master=!0,f.push(c)}for(var b=[],h=this.registry[i].siblings.length-1;h>-1;h+=-1){var _=this.registry[i].siblings.pop();f.indexOf(_)===-1&&b.push(_)}for(var h=b.length-1;h>-1;h+=-1)this.registry[i].siblings.push(b[h])}}for(var g=this.reflist.length-1;g>-1;g--)this.reflist[g].id===i&&(this.reflist=this.reflist.slice(0,g).concat(this.reflist.slice(g+1)));delete this.registry[i],delete this.refhash[i],this.return_data.bibchange=!0}};a.Registry.prototype.doinserts=function(e){var t,i,r,s,o,n,l;typeof e=="string"&&(e=[e]);for(var n=0,l=e.length;n<l;n+=1)t=e[n],this.registry[t]||(i=this.state.retrieveItem(t),r=a.getAmbiguousCite.call(this.state,i),this.ambigsTouched[r]=!0,i.legislation_id||(this.akeys[r]=!0),s={id:""+t,seq:0,offset:0,sortkeys:!1,ambig:!1,rendered:!1,disambig:!1,ref:i,newItem:!0},this.registry[t]=s,this.citationreg.citationsByItemId&&this.citationreg.citationsByItemId[t]&&(this.registry[t]["first-reference-note-number"]=this.citationreg.citationsByItemId[t][0].properties.noteIndex),o=a.getAmbigConfig.call(this.state),this.registerAmbigToken(r,t,o),this.touched[t]=!0,this.return_data.bibchange=!0)};a.Registry.prototype.rebuildlist=function(e){var t,i,r,s;if(e)for(this.reflist=[],t=this.mylist.length,i=0;i<t;i+=1)r=this.mylist[i],s=this.registry[r],this.reflist.push(s),this.oldseq[r]=this.registry[r].seq,this.registry[r].seq=i+1;else for(this.reflist_inserts=[],t=this.mylist.length,i=0;i<t;i+=1)r=this.mylist[i],s=this.registry[r],s.newItem&&this.reflist_inserts.push(s),this.oldseq[r]=this.registry[r].seq,this.registry[r].seq=i+1};a.Registry.prototype.dorefreshes=function(){var e,t,i,r,s;for(var e in this.refreshes)if(t=this.registry[e],!!t){t.sortkeys=void 0,i=this.state.refetchItem(e);var r=t.ambig;typeof r>"u"&&(this.state.tmp.disambig_settings=!1,r=a.getAmbiguousCite.call(this.state,i),s=a.getAmbigConfig.call(this.state),this.registerAmbigToken(r,e,s));for(var o in this.ambigresets)if(this.ambigresets[o]===1){var n=this.ambigcites[r][0],i=this.state.refetchItem(n);this.registry[n].disambig=new a.AmbigConfig,this.state.tmp.disambig_settings=!1;var r=a.getAmbiguousCite.call(this.state,i),s=a.getAmbigConfig.call(this.state);this.registerAmbigToken(r,n,s)}this.state.tmp.taintedItemIDs[e]=!0,this.ambigsTouched[r]=!0,i.legislation_id||(this.akeys[r]=!0),this.touched[e]=!0}};a.Registry.prototype.setdisambigs=function(){for(var e in this.ambigsTouched)this.state.disambiguate.run(e);this.ambigsTouched={},this.akeys={}};a.Registry.prototype.renumber=function(){var e,t,i;for(this.state.bibliography_sort.opt.citation_number_sort_direction===a.DESCENDING&&(this.state.bibliography_sort.tmp.citation_number_map={}),e=this.reflist.length,t=0;t<e;t+=1)i=this.reflist[t],i.seq=t+1,this.state.bibliography_sort.opt.citation_number_sort_direction===a.DESCENDING&&(this.state.bibliography_sort.tmp.citation_number_map[i.seq]=this.reflist.length-i.seq+1),this.state.opt.update_mode===a.NUMERIC&&i.seq!=this.oldseq[i.id]&&(this.state.tmp.taintedItemIDs[i.id]=!0),i.seq!=this.oldseq[i.id]&&(this.return_data.bibchange=!0)};a.Registry.prototype.setsortkeys=function(){for(var e,t=0,i=this.mylist.length;t<i;t+=1){var e=this.mylist[t];(this.touched[e]||this.state.tmp.taintedItemIDs[e]||!this.registry[e].sortkeys)&&(this.registry[e].sortkeys=a.getSortKeys.call(this.state,this.state.retrieveItem(e),"bibliography_sort"))}};a.Registry.prototype._insertItem=function(e,t){return t.splice(this._locationOf(e,t)+1,0,e),t};a.Registry.prototype._locationOf=function(e,t,i,r){if(t.length===0)return-1;i=i||0,r=r||t.length;var s=i+r>>1,o=this.sorter.compareKeys(e,t[s]);if(r-i<=1)return o==-1?s-1:s;switch(o){case-1:return this._locationOf(e,t,i,s);case 0:return s;case 1:return this._locationOf(e,t,s,r)}};a.Registry.prototype.sorttokens=function(e){var t,i,r,s;if(!e){for(this.reflist_inserts=[],t=this.mylist.length,s=0;s<t;s+=1)i=this.mylist[s],r=this.registry[i],r.newItem&&this.reflist_inserts.push(r);for(var o in this.state.tmp.taintedItemIDs)if(this.registry[o]&&!this.registry[o].newItem)for(var n=this.reflist.length-1;n>-1;n--)this.reflist[n].id===o&&(this.reflist_inserts.push(this.reflist[n]),this.reflist=this.reflist.slice(0,n).concat(this.reflist.slice(n+1)));for(var n=0,l=this.reflist_inserts.length;n<l;n++){var r=this.reflist_inserts[n];delete r.newItem,this.reflist=this._insertItem(r,this.reflist)}for(s=0;s<t;s+=1)i=this.mylist[s],r=this.registry[i],this.registry[i].seq=s+1}};a.Registry.Comparifier=function(e,t){var i,r,s,o,n=a.getSortCompare.call(e,e.opt["default-locale-sort"]);i=e[t].opt.sort_directions,this.compareKeys=function(l,m){for(r=l.sortkeys?l.sortkeys.length:0,s=0;s<r;s+=1){var u=0;if(l.sortkeys[s]===m.sortkeys[s]?u=0:typeof l.sortkeys[s]>"u"?u=i[s][1]:typeof m.sortkeys[s]>"u"?u=i[s][0]:u=n(l.sortkeys[s],m.sortkeys[s]),0<u)return i[s][1];if(0>u)return i[s][0]}return l.seq>m.seq?1:l.seq<m.seq?-1:0},o=this.compareKeys,this.compareCompositeKeys=function(l,m){return o(l[1],m[1])}};a.Registry.prototype.compareRegistryTokens=function(e,t){return e.seq>t.seq?1:e.seq<t.seq?-1:0};a.Registry.prototype.registerAmbigToken=function(e,t,i){if(this.registry[t]||a.debug("Warning: unregistered item: itemID=("+t+"), akey=("+e+")"),this.registry[t]&&this.registry[t].disambig&&this.registry[t].disambig.names)for(var r=0,s=i.names.length;r<s;r+=1){var o=i.names[r],n=this.registry[t].disambig.names[r];if(o!==n)this.state.tmp.taintedItemIDs[t]=!0;else if(i.givens[r])for(var l=0,m=i.givens[r].length;l<m;l+=1){var u=i.givens[r][l],p=this.registry[t].disambig.givens[r][l];u!==p&&(this.state.tmp.taintedItemIDs[t]=!0)}}this.ambigcites[e]||(this.ambigcites[e]=[]),this.ambigcites[e].indexOf(""+t)===-1&&this.ambigcites[e].push(""+t),this.registry[t].ambig=e,this.registry[t].disambig=a.cloneAmbigConfig(i)};a.getSortKeys=function(e,t){var i,r,s,o,n,l;for(i=this.tmp.area,r=this.tmp.root,s=this.tmp.extension,o=a.Util.Sort.strip_prepositions,this.tmp.area=t,this.tmp.root=t.indexOf("_")>-1?t.slice(0,-5):t,this.tmp.extension="_sort",this.tmp.disambig_override=!0,this.tmp.disambig_request=!1,this.tmp.suppress_decorations=!0,a.getCite.call(this,e),this.tmp.suppress_decorations=!1,this.tmp.disambig_override=!1,n=this[t].keys.length,l=0;l<n;l+=1)this[t].keys[l]=o(this[t].keys[l]);return this.tmp.area=i,this.tmp.root=r,this.tmp.extension=s,this[t].keys};a.Registry.NameReg=function(e){var t,i,r,s,o,n,l,m,u,p,f,c;this.state=e,this.namereg={},this.nameind={},this.nameindpkeys={},this.itemkeyreg={},l=function(d){return d||(d=""),d.replace(/\./g," ").replace(/\s+/g," ").replace(/\s+$/,"")},m=function(d,b,h){t=l(h.family),d.opt["demote-non-dropping-particle"]==="never"&&h["non-dropping-particle"]&&h.family&&(t=`${t} ${h["non-dropping-particle"]}`),r=l(h.given);var _=r.match(/[,\!]* ([^,]+)$/);_&&_[1]===_[1].toLowerCase()&&(r=r.replace(/[,\!]* [^,]+$/,"")),i=a.Util.Names.initializeWith(d,r,"%s"),d.citation.opt["givenname-disambiguation-rule"]==="by-cite"&&(t=""+b+t)},u=function(d,b,h,_,g,y){var x;if(e.tmp.area.slice(0,12)==="bibliography"&&!g)return typeof y=="string"?1:2;var v=e.nameOutput.getName(b,"locale-translit",!0);b=v.name,m(this.state,""+d,b),x=2,s=e.opt["disambiguate-add-givenname"],o=e.citation.opt["givenname-disambiguation-rule"];var E=o;if(o==="by-cite"&&(o="all-names"),g==="short"?x=0:typeof y=="string"&&(x=1),typeof this.namereg[t]>"u"||typeof this.namereg[t].ikey[i]>"u")return x;if(E==="by-cite"&&x<=_)return _;if(!s||typeof o=="string"&&o.slice(0,12)==="primary-name"&&h>0||(!o||o==="all-names"||o==="primary-name"?(this.namereg[t].count>1&&(x=1),(this.namereg[t].ikey&&this.namereg[t].ikey[i].count>1||this.namereg[t].count>1&&typeof y!="string")&&(x=2)):(o==="all-names-with-initials"||o==="primary-name-with-initials")&&(this.namereg[t].count>1?x=1:x=0),e.registry.registry[d]))return x;if(g=="short")return 0;if(typeof y=="string")return 1},p=function(d){var b,h,_,g,y;(typeof d=="string"||typeof d=="number")&&(d=[""+d]);var x={};for(h=d.length,b=0;b<h;b+=1)if(g=""+d[b],!!this.nameind[g]){for(y in this.nameind[g])if(this.nameind[g].hasOwnProperty(y)){var v=y.split("::");if(t=v[0],i=v[1],r=v[2],typeof this.namereg[t]>"u")continue;if(n=this.namereg[t].items,r&&this.namereg[t].ikey[i]&&this.namereg[t].ikey[i].skey[r]&&(c=this.namereg[t].ikey[i].skey[r].items,_=c.indexOf(""+g),_>-1&&(this.namereg[t].ikey[i].skey[r].items=c.slice(0,_).concat(c.slice([_+1]))),this.namereg[t].ikey[i].skey[r].items.length===0&&(delete this.namereg[t].ikey[i].skey[r],this.namereg[t].ikey[i].count+=-1,this.namereg[t].ikey[i].count<2)))for(var E=0,w=this.namereg[t].ikey[i].items.length;E<w;E+=1)e.tmp.taintedItemIDs[this.namereg[t].ikey[i].items[E]]=!0;if(i&&this.namereg[t].ikey[i]&&(_=this.namereg[t].ikey[i].items.indexOf(""+g),_>-1&&(n=this.namereg[t].ikey[i].items.slice(),this.namereg[t].ikey[i].items=n.slice(0,_).concat(n.slice([_+1]))),this.namereg[t].ikey[i].items.length===0&&(delete this.namereg[t].ikey[i],this.namereg[t].count+=-1,this.namereg[t].count<2)))for(var E=0,w=this.namereg[t].items.length;E<w;E+=1)e.tmp.taintedItemIDs[this.namereg[t].items[E]]=!0;t&&(_=this.namereg[t].items.indexOf(""+g),_>-1&&(n=this.namereg[t].items.slice(),this.namereg[t].items=n.slice(0,_).concat(n.slice([_+1],n.length))),this.namereg[t].items.length<2&&delete this.namereg[t]),delete this.nameind[g][y]}delete this.nameind[g],delete this.nameindpkeys[g]}return x},f=function(d,b,h){var _,g,y=e.nameOutput.getName(b,"locale-translit",!0);if(b=y.name,!(e.citation.opt["givenname-disambiguation-rule"]&&e.citation.opt["givenname-disambiguation-rule"].slice(0,8)==="primary-"&&h!==0)){if(m(this.state,""+d,b),t&&(typeof this.namereg[t]>"u"?(this.namereg[t]={},this.namereg[t].count=0,this.namereg[t].ikey={},this.namereg[t].items=[d]):this.namereg[t].items.indexOf(d)===-1&&this.namereg[t].items.push(d)),t&&i)if(typeof this.namereg[t].ikey[i]>"u"){if(this.namereg[t].ikey[i]={},this.namereg[t].ikey[i].count=0,this.namereg[t].ikey[i].skey={},this.namereg[t].ikey[i].items=[d],this.namereg[t].count+=1,this.namereg[t].count===2)for(var _=0,g=this.namereg[t].items.length;_<g;_+=1)e.tmp.taintedItemIDs[this.namereg[t].items[_]]=!0}else this.namereg[t].ikey[i].items.indexOf(d)===-1&&this.namereg[t].ikey[i].items.push(d);if(t&&i&&r)if(typeof this.namereg[t].ikey[i].skey[r]>"u"){if(this.namereg[t].ikey[i].skey[r]={},this.namereg[t].ikey[i].skey[r].items=[d],this.namereg[t].ikey[i].count+=1,this.namereg[t].ikey[i].count===2)for(var _=0,g=this.namereg[t].ikey[i].items.length;_<g;_+=1)e.tmp.taintedItemIDs[this.namereg[t].ikey[i].items[_]]=!0}else this.namereg[t].ikey[i].skey[r].items.indexOf(d)===-1&&this.namereg[t].ikey[i].skey[r].items.push(d);typeof this.nameind[d]>"u"&&(this.nameind[d]={},this.nameindpkeys[d]={}),t&&(this.nameind[d][t+"::"+i+"::"+r]=!0,this.nameindpkeys[d][t]=this.namereg[t])}},this.addname=f,this.delitems=p,this.evalname=u};a.Registry.CitationReg=function(){this.citationById={},this.citationByIndex=[]};a.Disambiguation=function(e){this.state=e,this.sys=this.state.sys,this.registry=e.registry.registry,this.ambigcites=e.registry.ambigcites,this.configModes(),this.debug=!1};a.Disambiguation.prototype.run=function(e){this.modes.length&&(this.debug&&this.state.sys.print("[A] === RUN ==="),this.akey=e,this.initVars(e)&&this.runDisambig())};a.Disambiguation.prototype.runDisambig=function(){var e;for(this.debug&&this.state.sys.print("[C] === runDisambig() ==="),this.initGivens=!0;this.lists.length;){for(this.gnameset=0,this.gname=0,this.clashes=[1,0];this.lists[0][1].length;)this.listpos=0,this.base||(this.base=this.lists[0][0]),e=this.incrementDisambig(),this.scanItems(this.lists[0]),this.evalScan(e);this.lists=this.lists.slice(1)}};a.Disambiguation.prototype.scanItems=function(e){var t,i,r;this.debug&&this.state.sys.print("[2] === scanItems() ==="),this.Item=e[1][0],this.ItemCite=a.getAmbiguousCite.call(this.state,this.Item,this.base,!0),this.scanlist=e[1],this.partners=[],this.partners.push(this.Item),this.nonpartners=[];for(var s=0,t=1,i=e[1].length;t<i;t+=1){r=e[1][t];var o=a.getAmbiguousCite.call(this.state,r,this.base,!0);this.debug&&t>1&&this.state.sys.print("  -----------"),this.ItemCite===o?(this.debug&&(this.state.sys.print("  [CLASH]--> "+this.Item.id+": "+this.ItemCite),this.state.sys.print("             "+r.id+": "+o)),s+=1,this.partners.push(r)):(this.debug&&(this.state.sys.print("  [clear]--> "+this.Item.id+": "+this.ItemCite),this.state.sys.print("             "+r.id+": "+o)),this.nonpartners.push(r))}this.clashes[0]=this.clashes[1],this.clashes[1]=s};a.Disambiguation.prototype.evalScan=function(e){this[this.modes[this.modeindex]](e),e&&(this.modeindex<this.modes.length-1?this.modeindex+=1:this.lists[this.listpos+1]=[this.base,[]])};a.Disambiguation.prototype.disNames=function(e){var t,i;if(this.debug&&this.state.sys.print("[3] == disNames() =="),this.clashes[1]===0&&this.nonpartners.length===1)this.captureStepToBase(),this.debug&&(this.state.sys.print("  ** RESOLUTION [a]: lone partner, one nonpartner"),this.state.sys.print("  registering "+this.partners[0].id+" and "+this.nonpartners[0].id)),this.state.registry.registerAmbigToken(this.akey,""+this.nonpartners[0].id,this.betterbase),this.state.registry.registerAmbigToken(this.akey,""+this.partners[0].id,this.betterbase),this.lists[this.listpos]=[this.betterbase,[]];else if(this.clashes[1]===0)this.captureStepToBase(),this.debug&&(this.state.sys.print("  ** RESOLUTION [b]: lone partner, unknown number of remaining nonpartners"),this.state.sys.print("  registering "+this.partners[0].id)),this.state.registry.registerAmbigToken(this.akey,""+this.partners[0].id,this.betterbase),this.lists[this.listpos]=[this.betterbase,this.nonpartners],this.nonpartners.length&&(this.initGivens=!0);else if(this.nonpartners.length===1)this.captureStepToBase(),this.debug&&(this.state.sys.print("  ** RESOLUTION [c]: lone nonpartner, unknown number of partners remaining"),this.state.sys.print("  registering "+this.nonpartners[0].id)),this.state.registry.registerAmbigToken(this.akey,""+this.nonpartners[0].id,this.betterbase),this.lists[this.listpos]=[this.betterbase,this.partners];else if(this.clashes[1]<this.clashes[0])this.captureStepToBase(),this.debug&&this.state.sys.print("  ** RESOLUTION [d]: better result, but no entries safe to register"),this.lists[this.listpos]=[this.betterbase,this.partners],this.lists.push([this.betterbase,this.nonpartners]);else if(this.debug&&this.state.sys.print("  ** RESOLUTION [e]: no improvement, and clashes remain"),e&&(this.lists[this.listpos]=[this.betterbase,this.nonpartners],this.lists.push([this.betterbase,this.partners]),this.modeindex===this.modes.length-1)){this.debug&&this.state.sys.print("     (registering clashing entries because we've run out of options)");for(var t=0,i=this.partners.length;t<i;t+=1)this.state.registry.registerAmbigToken(this.akey,""+this.partners[t].id,this.betterbase);this.lists[this.listpos]=[this.betterbase,[]]}};a.Disambiguation.prototype.disExtraText=function(){this.debug&&this.state.sys.print("[3] === disExtraText ==");var e=!1;if(this.clashes[1]===0&&this.nonpartners.length<2&&(e=!0),!e&&(!this.base.disambiguate||this.state.tmp.disambiguate_count!==this.state.tmp.disambiguate_maxMax))if(this.modeindex=0,this.base.disambiguate=this.state.tmp.disambiguate_count,this.betterbase.disambiguate=this.state.tmp.disambiguate_count,this.base.disambiguate)this.disNames();else{this.initGivens=!0,this.base.disambiguate=1;for(var t=0,i=this.lists[this.listpos][1].length;t<i;t+=1)this.state.tmp.taintedItemIDs[this.lists[this.listpos][1][t].id]=!0}else if(e||this.state.tmp.disambiguate_count===this.state.tmp.disambiguate_maxMax)if(e||this.modeindex===this.modes.length-1){for(var r=this.lists[this.listpos][0],t=0,i=this.lists[this.listpos][1].length;t<i;t+=1)this.state.tmp.taintedItemIDs[this.lists[this.listpos][1][t].id]=!0,this.state.registry.registerAmbigToken(this.akey,""+this.lists[this.listpos][1][t].id,r);this.lists[this.listpos]=[this.betterbase,[]]}else{this.modeindex=this.modes.length-1;var r=this.lists[this.listpos][0];r.disambiguate=!0;for(var t=0,i=this.lists[this.listpos][1].length;t<i;t+=1)this.state.tmp.taintedItemIDs[this.lists[this.listpos][1][t].id]=!0,this.state.registry.registerAmbigToken(this.akey,""+this.lists[this.listpos][1][t].id,r)}};a.Disambiguation.prototype.disYears=function(){var e,t,i,r;this.debug&&this.state.sys.print("[3] === disYears =="),i=[];var s=this.lists[this.listpos][0];if(this.clashes[1])for(var o=0,n=this.state.registry.mylist.length;o<n;o+=1)for(var l=this.state.registry.mylist[o],m=0,u=this.lists[this.listpos][1].length;m<u;m+=1){var r=this.lists[this.listpos][1][m];if(r.id==l){i.push(this.registry[r.id]);break}}i.sort(this.state.registry.sorter.compareKeys);for(var e=0,t=i.length;e<t;e+=1){s.year_suffix=""+e;var p=this.state.registry.registry[i[e].id].disambig;this.state.registry.registerAmbigToken(this.akey,""+i[e].id,s),a.ambigConfigDiff(p,s)&&(this.state.tmp.taintedItemIDs[i[e].id]=!0)}this.lists[this.listpos]=[this.betterbase,[]]};a.Disambiguation.prototype.incrementDisambig=function(){if(this.debug&&this.state.sys.print(`
[1] === incrementDisambig() ===`),this.initGivens)return this.initGivens=!1,!1;var e=!1,t=!0;if(this.modes[this.modeindex]==="disNames"){t=!1,typeof this.givensMax!="number"&&(t=!0);var i=!1;typeof this.namesMax!="number"&&(i=!0),typeof this.givensMax=="number"&&(this.base.givens.length&&this.base.givens[this.gnameset][this.gname]<this.givensMax?this.base.givens[this.gnameset][this.gname]+=1:t=!0),typeof this.namesMax=="number"&&t&&(this.state.opt["disambiguate-add-names"]?(i=!1,this.gname<this.namesMax?(this.base.names[this.gnameset]+=1,this.gname+=1):i=!0):i=!0),typeof this.namesetsMax=="number"&&i&&this.gnameset<this.namesetsMax&&(this.gnameset+=1,this.base.names[this.gnameset]=1,this.gname=0),this.debug&&(this.state.sys.print("    ------------------"),this.state.sys.print("    incremented values"),this.state.sys.print("    ------------------"),this.state.sys.print("    | gnameset: "+this.gnameset),this.state.sys.print("    | gname: "+this.gname),this.state.sys.print("    | names value: "+this.base.names[this.gnameset]),this.base.givens.length?this.state.sys.print("    | givens value: "+this.base.givens[this.gnameset][this.gname]):this.state.sys.print("    | givens value: nil"),this.state.sys.print("    | namesetsMax: "+this.namesetsMax),this.state.sys.print("    | namesMax: "+this.namesMax),this.state.sys.print("    | givensMax: "+this.givensMax)),(typeof this.namesetsMax!="number"||this.namesetsMax===-1||this.gnameset===this.namesetsMax)&&(!this.state.opt["disambiguate-add-names"]||typeof this.namesMax!="number"||this.gname===this.namesMax)&&(typeof this.givensMax!="number"||typeof this.base.givens[this.gnameset]>"u"||typeof this.base.givens[this.gnameset][this.gname]>"u"||this.base.givens[this.gnameset][this.gname]===this.givensMax)&&(e=!0,this.debug&&this.state.sys.print("    MAXED"))}else this.modes[this.modeindex]==="disExtraText"&&(this.base.disambiguate+=1,this.betterbase.disambiguate+=1);return e};a.Disambiguation.prototype.initVars=function(e){var t,i,r,s,o;if(this.debug&&this.state.sys.print("[B] === initVars() ==="),this.lists=[],this.base=!1,this.betterbase=!1,this.akey=e,this.maxNamesByItemId={},s=[],r=this.ambigcites[e],!r||!r.length)return!1;var n=this.state.refetchItem(""+r[0]);if(this.getCiteData(n),this.base=a.getAmbigConfig.call(this.state),r&&r.length>1){s.push([this.maxNamesByItemId[n.id],n]);for(var t=1,i=r.length;t<i;t+=1)n=this.state.refetchItem(""+r[t]),this.getCiteData(n,this.base),s.push([this.maxNamesByItemId[n.id],n]);s.sort(function(m,u){return m[0]>u[0]?1:m[0]<u[0]?-1:m[1].id>u[1].id?1:m[1].id<u[1].id?-1:0}),o=[];for(var t=0,i=s.length;t<i;t+=1)o.push(s[t][1]);this.lists.push([this.base,o]),this.Item=this.lists[0][1][0]}else this.Item=this.state.refetchItem(""+r[0]);if(this.modeindex=0,this.state.citation.opt["disambiguate-add-names"]||!0)this.namesMax=this.maxNamesByItemId[this.Item.id][0];else{var l;for(var t,i;t<i;t+=1);}return this.padBase(this.base),this.padBase(this.betterbase),this.base.year_suffix=!1,this.base.disambiguate=!1,this.betterbase.year_suffix=!1,this.betterbase.disambiguate=!1,this.state.citation.opt["givenname-disambiguation-rule"]==="by-cite"&&this.state.opt["disambiguate-add-givenname"]&&(this.givensMax=2),!0};a.Disambiguation.prototype.padBase=function(e){for(var t=0,i=e.names.length;t<i;t+=1){e.givens[t]||(e.givens[t]=[]);for(var r=0,s=e.names[t];r<s;r+=1)e.givens[t][r]||(e.givens[t][r]=0)}};a.Disambiguation.prototype.configModes=function(){var e,t;this.modes=[],e=this.state.opt["disambiguate-add-givenname"],t=this.state.citation.opt["givenname-disambiguation-rule"],(this.state.opt["disambiguate-add-names"]||e&&t==="by-cite")&&this.modes.push("disNames"),this.state.opt.development_extensions.prioritize_disambiguate_condition?(this.state.opt.has_disambiguate&&this.modes.push("disExtraText"),this.state.opt["disambiguate-add-year-suffix"]&&this.modes.push("disYears")):(this.state.opt["disambiguate-add-year-suffix"]&&this.modes.push("disYears"),this.state.opt.has_disambiguate&&this.modes.push("disExtraText"))};a.Disambiguation.prototype.getCiteData=function(e,t){if(!this.maxNamesByItemId[e.id]){a.getAmbiguousCite.call(this.state,e,t),t=a.getAmbigConfig.call(this.state),this.maxNamesByItemId[e.id]=a.getMaxVals.call(this.state),this.state.registry.registry[e.id].disambig.givens=this.state.tmp.disambig_settings.givens.slice();for(var i=0,r=this.state.registry.registry[e.id].disambig.givens.length;i<r;i+=1)this.state.registry.registry[e.id].disambig.givens[i]=this.state.tmp.disambig_settings.givens[i].slice();this.namesetsMax=this.state.registry.registry[e.id].disambig.names.length-1,this.base||(this.base=t,this.betterbase=a.cloneAmbigConfig(t)),t.names.length<this.base.names.length&&(this.base=t);for(var i=0,r=t.names.length;i<r;i+=1)t.names[i]>this.base.names[i]&&(this.base.givens[i]=t.givens[i].slice(),this.base.names[i]=t.names[i],this.betterbase.names=this.base.names.slice(),this.betterbase.givens=this.base.givens.slice(),this.padBase(this.base),this.padBase(this.betterbase));this.betterbase.givens=this.base.givens.slice();for(var s=0,o=this.base.givens.length;s<o;s+=1)this.betterbase.givens[s]=this.base.givens[s].slice()}};a.Disambiguation.prototype.captureStepToBase=function(){this.state.citation.opt["givenname-disambiguation-rule"]==="by-cite"&&this.base.givens&&this.base.givens.length&&typeof this.base.givens[this.gnameset][this.gname]<"u"&&(this.betterbase.givens.length<this.base.givens.length&&(this.betterbase.givens=JSON.parse(JSON.stringify(this.base.givens))),this.betterbase.givens[this.gnameset][this.gname]=this.base.givens[this.gnameset][this.gname]),this.betterbase.names[this.gnameset]=this.base.names[this.gnameset]};a.Engine.prototype.getJurisdictionList=function(e){for(var t=[],i=e.split(":"),r=i.length;r>0;r--){var s=i.slice(0,r).join(":");if(t.push(s),this.opt.jurisdiction_fallbacks[s]){var o=this.opt.jurisdiction_fallbacks[s];t.push(o)}}return t.indexOf("us")===-1&&t.push("us"),t};a.Engine.prototype.loadStyleModule=function(e,t,i){var r=null,s=0;this.juris[e]={};var o=a.setupXml(t);o.addMissingNameNodes(o.dataObj),o.addInstitutionNodes(o.dataObj),o.insertPublisherAndPlace(o.dataObj),o.flagDateMacros(o.dataObj);for(var c=o.getNodesByName(o.dataObj,"law-module"),n=0,l=c.length;n<l;n++){var m=o.getAttributeValue(c[n],"types");if(m){this.juris[e].types={},m=m.split(/\s+/);for(var u=0,p=m.length;u<p;u++)this.juris[e].types[m[u]]=!0}i||(r=o.getAttributeValue(c[n],"fallback"),r&&e!=="us"&&(this.opt.jurisdiction_fallbacks[e]=r))}var f=this.opt.lang?this.opt.lang:this.opt["default-locale"][0];a.SET_COURT_CLASSES(this,f,o,o.dataObj),this.juris[e].types||(this.juris[e].types=a.MODULE_TYPES);for(var c=o.getNodesByName(o.dataObj,"macro"),n=0,l=c.length;n<l;n++){var d=o.getAttributeValue(c[n],"name");if(!a.MODULE_MACROS[d]){a.debug('CSL: skipping non-modular macro name "'+d+'" in module context');continue}s++,this.juris[e][d]=[],this.buildTokenLists(c[n],this.juris[e][d]),this.configureTokenList(this.juris[e][d])}return r};a.Engine.prototype.retrieveAllStyleModules=function(e){var t={},i=this.locale[this.opt.lang].opts["jurisdiction-preference"];i=i||[],i=[""].concat(i);for(var r=i.length-1;r>-1;r--)for(var s=i[r],o=0,n=e.length;o<n;o++){var l=e[o];if(!this.opt.jurisdictions_seen[l]){var m=this.sys.retrieveStyleModule(l,s);(!m&&!s||m)&&(this.opt.jurisdictions_seen[l]=!0),m&&(t[l]=m)}}return t};a.ParticleList=(function(){var e=[[[0,1],null]],t=[[[0,3],null]],i=[[null,[0,1]]],r=[[null,[0,2]]],s=[[null,[0,3]]],o=[[null,[0,1]],[[0,1],null]],n=[[null,[0,2]],[[0,2],null]],l=[[[0,1],null],[null,[0,1]]],m=[[[0,2],null],[null,[0,2]]],u=[[[0,3],null],[null,[0,3]]],p=[[null,[0,2]],[[0,1],[1,2]]],f=[["'s",i],["'s-",i],["'t",i],["a",i],["aan 't",r],["aan de",r],["aan den",r],["aan der",r],["aan het",r],["aan t",r],["aan",i],["ad-",o],["adh-",o],["af",o],["al",o],["al-",o],["am de",r],["am",i],["an-",o],["ar-",o],["as-",o],["ash-",o],["at-",o],["ath-",o],["auf dem",m],["auf den",m],["auf der",m],["auf ter",r],["auf",l],["aus 'm",m],["aus dem",m],["aus den",m],["aus der",m],["aus m",m],["aus",l],["aus'm",m],["az-",o],["a\u0161-",o],["a\u1E0D-",o],["a\u1E0F-",o],["a\u1E63-",o],["a\u1E6D-",o],["a\u1E6F-",o],["a\u1E93-",o],["ben",i],["bij 't",r],["bij de",r],["bij den",r],["bij het",r],["bij t",r],["bij",i],["bin",i],["boven d",r],["boven d'",r],["d",i],["d'",o],["da",o],["dal",i],["dal'",i],["dall'",i],["dalla",i],["das",o],["de die le",s],["de die",r],["de l",r],["de l'",r],["de la",p],["de las",p],["de le",r],["de li",n],["de van der",s],["de",o],["de'",o],["deca",i],["degli",o],["dei",o],["del",o],["dela",e],["dell'",o],["della",o],["delle",o],["dello",o],["den",o],["der",o],["des",o],["di",o],["die le",r],["do",i],["don",i],["dos",o],["du",o],["ed-",o],["edh-",o],["el",o],["el-",o],["en-",o],["er-",o],["es-",o],["esh-",o],["et-",o],["eth-",o],["ez-",o],["e\u0161-",o],["e\u1E0D-",o],["e\u1E0F-",o],["e\u1E63-",o],["e\u1E6D-",o],["e\u1E6F-",o],["e\u1E93-",o],["het",i],["i",i],["il",e],["im",i],["in 't",r],["in de",r],["in den",r],["in der",n],["in het",r],["in t",r],["in",i],["l",i],["l'",i],["la",i],["las",i],["le",i],["les",o],["lo",o],["los",i],["lou",i],["of",i],["onder 't",r],["onder de",r],["onder den",r],["onder het",r],["onder t",r],["onder",i],["op 't",r],["op de",n],["op den",r],["op der",r],["op gen",r],["op het",r],["op t",r],["op ten",r],["op",i],["over 't",r],["over de",r],["over den",r],["over het",r],["over t",r],["over",i],["s",i],["s'",i],["sen",e],["t",i],["te",i],["ten",i],["ter",i],["tho",i],["thoe",i],["thor",i],["to",i],["toe",i],["tot",i],["uijt 't",r],["uijt de",r],["uijt den",r],["uijt te de",s],["uijt ten",r],["uijt",i],["uit 't",r],["uit de",r],["uit den",r],["uit het",r],["uit t",r],["uit te de",s],["uit ten",r],["uit",i],["unter",i],["v",i],["v.",i],["v.d.",i],["van 't",r],["van de l",s],["van de l'",s],["van de",r],["van de",r],["van den",r],["van der",r],["van gen",r],["van het",r],["van la",r],["van t",r],["van ter",r],["van van de",s],["van",o],["vander",i],["vd",i],["ver",i],["vom und zum",t],["vom",o],["von 't",r],["von dem",m],["von den",m],["von der",m],["von t",r],["von und zu",u],["von zu",m],["von",l],["voor 't",r],["voor de",r],["voor den",r],["voor in 't",s],["voor in t",s],["voor",i],["vor der",m],["vor",l],["z",e],["ze",e],["zu",l],["zum",o],["zur",o]];return f})();a.parseParticles=(function(){function e(r,s,o){var n=r;r=o?r.toLowerCase():r;var l=[],m,u;s?(r=r.split("").reverse().join(""),m=a.PARTICLE_GIVEN_REGEXP):m=a.PARTICLE_FAMILY_REGEXP;for(var p=r.match(m);p;){var f=s?p[1].split("").reverse().join(""):p[1],c=p?f:!1,c=c?f.replace(/^[-\'\u02bb\u2019\s]*(.).*$/,"$1"):!1;if(u=c?c.toUpperCase()!==c:!1,!u)break;s?(l.push(n.slice(f.length*-1)),n=n.slice(0,f.length*-1)):(l.push(n.slice(0,f.length)),n=n.slice(f.length)),r=p[2],p=r.match(m)}if(s){r=r.split("").reverse().join(""),l.reverse();for(var d=1,b=l.length;d<b;d++)l[d].slice(0,1)==" "&&(l[d-1]+=" ");for(var d=0,b=l.length;d<b;d++)l[d].slice(0,1)==" "&&(l[d]=l[d].slice(1));r=n.slice(0,r.length)}else r=n.slice(r.length*-1);return[u,r,l]}function t(r){var s=r.slice(-1);return r=r.trim(),s===" "&&["'","\u2019"].indexOf(r.slice(-1))>-1&&(r+=" "),r}function i(r){if(!r.suffix&&r.given){var s=r.given.match(/(\s*,!*\s*)/);if(s){var o=r.given.indexOf(s[1]),n=r.given.slice(o+s[1].length),l=r.given.slice(o,o+s[1].length).replace(/\s*/g,"");n.replace(/\./g,"")==="et al"&&!r["dropping-particle"]?(r["dropping-particle"]=n,r["comma-dropping-particle"]=","):(l.length===2&&(r["comma-suffix"]=!0),r.suffix=n),r.given=r.given.slice(0,o)}}}return function(r){var l=e(r.family),s=l[1],o=l[2];r.family=s;var n=t(o.join(""));n&&(r["non-dropping-particle"]=n),i(r);var l=e(r.given,!0),m=l[1],u=l[2];r.given=m;var p=u.join("").trim();p&&(r["dropping-particle"]=p)}})();Ar.exports=a});var Ct={};se(Ct,{currentVersion:()=>Kr,retrieveLastVersion:()=>ta,retrieveVersion:()=>Zr,save:()=>ia,undo:()=>ea});function Kr(){return this.log.length}function Zr(e=1){if(e<=0||e>this.currentVersion())return null;{let[t,i]=this.log[e-1],r=new this.constructor(JSON.parse(t),JSON.parse(i));return r.log=this.log.slice(0,e),r}}function ea(e=1){return this.retrieveVersion(this.currentVersion()-e)}function ta(){return this.retrieveVersion(this.currentVersion())}function ia(){return this.log.push([JSON.stringify(this.data),JSON.stringify(this._options)]),this}var kt={};se(kt,{defaultOptions:()=>aa,options:()=>sa});var Ci=["real","string"],ki=["json","html","string","rtf"],Di=["csl","bibtex","bibtxt","citation-*","ris","ndjson"],Ni=["string","function"];function Ie(e){if(typeof e!="object")throw new TypeError("Options not an object!");let{format:t,type:i,style:r,lang:s,append:o,prepend:n}=e;if(t&&!Ci.includes(t))throw new TypeError(`Option format ("${t}") should be one of: ${Ci}`);if(i&&!ki.includes(i))throw new TypeError(`Option type ("${i}") should be one of: ${ki}`);if(r&&!Di.includes(r)&&!/^citation/.test(r))throw new TypeError(`Option style ("${r}") should be one of: ${Di}`);if(s&&typeof s!="string")throw new TypeError(`Option lang should be a string, but is a ${typeof s}`);if(n&&!Ni.includes(typeof n))throw new TypeError(`Option prepend should be a string or a function, but is a ${typeof n}`);if(o&&!Ni.includes(typeof o))throw new TypeError(`Option append should be a string or a function, but is a ${typeof o}`);if(/^citation/.test(r)&&i==="json")throw new Error(`Combination type/style of json/citation-* is not valid: ${i}/${r}`);return!0}function ra(e){if(typeof e!="object")throw new TypeError("Options should be an object");if(e.output)Ie(e.output);else{if(e.maxChainLength&&typeof e.maxChainLength!="number")throw new TypeError("Option maxChainLength should be a number");if(e.forceType&&typeof e.forceType!="string")throw new TypeError("Option forceType should be a string");if(e.generateGraph!=null&&typeof e.generateGraph!="boolean")throw new TypeError("Option generateGraph should be a boolean");if(e.strict!=null&&typeof e.strict!="boolean")throw new TypeError("Option strict should be a boolean");if(e.target!=null&&typeof e.target!="string")throw new TypeError("Option target should be a boolean")}return!0}var aa={format:"real",type:"json",style:"csl",lang:"en-US"};function sa(e,t){return Ie(e),t&&this.save(),Object.assign(this._options,e),this}var ci={};se(ci,{add:()=>ns,addAsync:()=>ls,reset:()=>cs,set:()=>ms,setAsync:()=>us});var bt={};se(bt,{add:()=>Ba,addDataParser:()=>lt,addTypeParser:()=>Mt,chain:()=>mi,chainAsync:()=>ui,chainLink:()=>as,chainLinkAsync:()=>ss,data:()=>Be,dataAsync:()=>Je,get:()=>ei,has:()=>Ua,hasDataParser:()=>$i,hasTypeParser:()=>oa,list:()=>ja,listDataParser:()=>Pa,listTypeParser:()=>na,remove:()=>Fa,removeDataParser:()=>mt,removeTypeParser:()=>Pt,treeTypeParser:()=>la,type:()=>ue,typeMatcher:()=>Bt,util:()=>os});var Rt={};se(Rt,{dataTypeOf:()=>Nt,typeOf:()=>Dt});function Dt(e){switch(e){case void 0:return"Undefined";case null:return"Null";default:return e.constructor.name}}function Nt(e){switch(typeof e){case"string":return"String";case"object":if(Array.isArray(e))return"Array";if(Dt(e)==="Object")return"SimpleObject";if(Dt(e)!=="Null")return"ComplexObject";default:return"Primitive"}}var Lt={};se(Lt,{applyGraph:()=>It,removeGraph:()=>zt});function It(e,t){if(e._graph){let i=t.findIndex(({type:r})=>r==="@else/list+object");i!==-1&&t.splice(i+1,0,...e._graph.slice(0,-1))}return e._graph=t,e}function zt(e){return delete e._graph,e}var Ft={};se(Ft,{DataParser:()=>$e,FormatParser:()=>He,TypeParser:()=>st});var ze={_output(e,t,i){this._log.push(t,i),!(this._levels.indexOf(e)<this._levels.indexOf(this.level))&&this._console.log(t,...i)},_console:null,_log:[],_levels:["http","debug","unmapped","info","warn","error","silent"],level:"silent"};for(let e of ze._levels)ze[e]=(t,...i)=>ze._output(e,t,i);typeof console.Console=="function"?ze._console=new console.Console(process.stderr):ze._console=console;var le=ze;var fe={},Te={},Le={};function Ri(e,t){switch(t){case"Array":return e.length===0||e.every(i=>ue(i)==="@csl/object")?"@csl/list+object":"@else/list+object";case"SimpleObject":case"ComplexObject":return"@csl/object";default:return"@invalid"}}function Ii(e=[],t){for(let i of e)if(fe[i].predicate(t))return Ii(fe[i].extensions,t)||i}function ue(e){let t=Nt(e);return t==="Array"&&e.length===0?Ri(e,t):Ii(Te[t],e)||Ri(e,t)}function Mt(e,{dataType:t,predicate:i,extends:r}){let s=[];e in Le&&(s=Le[e],delete Le[e],le.debug("[core]",`Subclasses "${s}" finally registered to parent type "${e}"`));let o={predicate:i,extensions:s};if(fe[e]=o,r){let n=fe[r];n?n.extensions.push(e):(Le[r]||(Le[r]=[]),Le[r].push(e),le.debug("[core]",`Subclass "${e}" is waiting on parent type "${r}"`))}else(Te[t]||(Te[t]=[])).push(e)}function oa(e){return Object.prototype.hasOwnProperty.call(fe,e)}function Pt(e){delete fe[e],[...Object.keys(Te).map(i=>Te[i]),...Object.keys(fe).map(i=>fe[i].extensions).filter(i=>i.length>0)].forEach(i=>{let r=i.indexOf(e);r>-1&&i.splice(r,1)})}function na(){return Object.keys(fe)}function la(){let e=t=>({name:t,children:fe[t].extensions.map(e)});return{name:"Type tree",children:Object.keys(Te).map(t=>({name:t,children:Te[t].map(e)}))}}var Bt=/^(?:@(.+?))(?:\/(?:(.+?)\+)?(?:(.+)))?$/;function ma(e,t,i){return(t=ua(t))in e?Object.defineProperty(e,t,{value:i,enumerable:!0,configurable:!0,writable:!0}):e[t]=i,e}function ua(e){var t=ca(e,"string");return typeof t=="symbol"?t:t+""}function ca(e,t){if(typeof e!="object"||!e)return e;var i=e[Symbol.toPrimitive];if(i!==void 0){var r=i.call(e,t||"default");if(typeof r!="object")return r;throw new TypeError("@@toPrimitive must return a primitive value.")}return(t==="string"?String:Number)(e)}var st=class{constructor(t){ma(this,"validDataTypes",["String","Array","SimpleObject","ComplexObject","Primitive"]),this.data=t}validateDataType(){let t=this.data.dataType;if(t&&!this.validDataTypes.includes(t))throw new RangeError(`dataType was ${t}; expected one of ${this.validDataTypes}`)}validateParseType(){let t=this.data.predicate;if(t&&!(t instanceof RegExp||typeof t=="function"))throw new TypeError(`predicate was ${typeof t}; expected RegExp or function`)}validateTokenList(){let t=this.data.tokenList;if(t&&typeof t!="object")throw new TypeError(`tokenList was ${typeof t}; expected object or RegExp`)}validatePropertyConstraint(){let t=this.data.propertyConstraint;if(t&&typeof t!="object")throw new TypeError(`propertyConstraint was ${typeof t}; expected array or object`)}validateElementConstraint(){let t=this.data.elementConstraint;if(t&&typeof t!="string")throw new TypeError(`elementConstraint was ${typeof t}; expected string`)}validateExtends(){let t=this.data.extends;if(t&&typeof t!="string")throw new TypeError(`extends was ${typeof t}; expected string`)}validate(){if(this.data===null||typeof this.data!="object")throw new TypeError(`typeParser was ${typeof this.data}; expected object`);this.validateDataType(),this.validateParseType(),this.validateTokenList(),this.validatePropertyConstraint(),this.validateElementConstraint(),this.validateExtends()}parseTokenList(){let t=this.data.tokenList;if(t)t instanceof RegExp&&(t={token:t});else return[];let{token:i,split:r=/\s+/,trim:s=!0,every:o=!0}=t,n=u=>s?u.trim():u,l=o?"every":"some";return[u=>n(u).split(r)[l](p=>i.test(p))]}parsePropertyConstraint(){return[].concat(this.data.propertyConstraint||[]).map(({props:i,match:r,value:s})=>{switch(i=[].concat(i),r){case"any":case"some":return o=>i.some(n=>n in o&&(!s||s(o[n])));case"none":return o=>!i.some(n=>n in o&&(!s||s(o[n])));default:return o=>i.every(n=>n in o&&(!s||s(o[n])))}})}parseElementConstraint(){let t=this.data.elementConstraint;return t?[i=>i.every(r=>ue(r)===t)]:[]}parsePredicate(){return this.data.predicate instanceof RegExp?[this.data.predicate.test.bind(this.data.predicate)]:this.data.predicate?[this.data.predicate]:[]}getCombinedPredicate(){let t=[...this.parsePredicate(),...this.parseTokenList(),...this.parsePropertyConstraint(),...this.parseElementConstraint()];return t.length===0?()=>!0:t.length===1?t[0]:i=>t.every(r=>r(i))}getDataType(){return this.data.dataType?this.data.dataType:this.data.predicate instanceof RegExp||this.data.tokenList?"String":this.data.elementConstraint?"Array":"Primitive"}get dataType(){return this.getDataType()}get predicate(){return this.getCombinedPredicate()}get extends(){return this.data.extends}},$e=class{constructor(t,{async:i}={}){this.parser=t,this.async=i}validate(){let t=this.parser;if(typeof t!="function")throw new TypeError(`parser was ${typeof t}; expected function`)}},He=class{constructor(t,i={}){this.format=t,i.parseType&&(this.typeParser=new st(i.parseType)),i.parse&&(this.dataParser=new $e(i.parse,{async:!1})),i.parseAsync&&(this.asyncDataParser=new $e(i.parseAsync,{async:!0}))}validateFormat(){let t=this.format;if(!Bt.test(t))throw new TypeError(`format name was "${t}"; didn't match expected pattern`)}validate(){this.validateFormat(),this.typeParser&&this.typeParser.validate(),this.dataParser&&this.dataParser.validate(),this.asyncDataParser&&this.asyncDataParser.validate()}};var Yt={};se(Yt,{clean:()=>Qt});var qi=at(Xt());function Ui(e,t){var i=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(s){return Object.getOwnPropertyDescriptor(e,s).enumerable})),i.push.apply(i,r)}return i}function Jt(e){for(var t=1;t<arguments.length;t++){var i=arguments[t]!=null?arguments[t]:{};t%2?Ui(Object(i),!0).forEach(function(r){Na(e,r,i[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(i)):Ui(Object(i)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(i,r))})}return e}function Na(e,t,i){return(t=Ra(t))in e?Object.defineProperty(e,t,{value:i,enumerable:!0,configurable:!0,writable:!0}):e[t]=i,e}function Ra(e){var t=Ia(e,"string");return typeof t=="symbol"?t:t+""}function Ia(e,t){if(typeof e!="object"||!e)return e;var i=e[Symbol.toPrimitive];if(i!==void 0){var r=i.call(e,t||"default");if(typeof r!="object")return r;throw new TypeError("@@toPrimitive must return a primitive value.")}return(t==="string"?String:Number)(e)}var za=1,Z=2,_e=3,Gi=4,$t={article:!0,"article-journal":!0,"article-magazine":!0,"article-newspaper":!0,bill:!0,book:!0,broadcast:!0,chapter:!0,classic:!0,collection:!0,dataset:!0,document:!0,entry:!0,"entry-dictionary":!0,"entry-encyclopedia":!0,event:!0,figure:!0,graphic:!0,hearing:!0,interview:!0,legal_case:!0,legislation:!0,manuscript:!0,map:!0,motion_picture:!0,musical_score:!0,pamphlet:!0,"paper-conference":!0,patent:!0,performance:!0,periodical:!0,personal_communication:!0,post:!0,"post-weblog":!0,regulation:!0,report:!0,review:!0,"review-book":!0,software:!0,song:!0,speech:!0,standard:!0,thesis:!0,treaty:!0,webpage:!0,"journal-article":"article-journal","book-chapter":"chapter","posted-content":"manuscript","proceedings-article":"paper-conference",dissertation:"thesis"},ji={author:Z,chair:Z,"collection-editor":Z,compiler:Z,composer:Z,"container-author":Z,contributor:Z,curator:Z,director:Z,editor:Z,"editorial-director":Z,"executive-producer":Z,guest:Z,host:Z,interviewer:Z,illustrator:Z,narrator:Z,organizer:Z,"original-author":Z,performer:Z,producer:Z,"reviewed-author":Z,recipient:Z,"script-writer":Z,"series-creator":Z,translator:Z,accessed:_e,"available-date":_e,container:_e,"event-date":_e,issued:_e,"original-date":_e,submitted:_e,type:Gi,categories:"object",custom:"object",id:["string","number"],language:"string",journalAbbreviation:"string",shortTitle:"string",abstract:"string",annote:"string",archive:"string",archive_collection:"string",archive_location:"string","archive-place":"string",authority:"string","call-number":"string","chapter-number":"string","citation-number":"string","citation-key":"string","citation-label":"string","collection-number":"string","collection-title":"string","container-title":"string","container-title-short":"string",dimensions:"string",division:"string",DOI:"string",edition:["string","number"],event:"string","event-title":"string","event-place":"string","first-reference-note-number":"string",genre:"string",ISBN:"string",ISSN:"string",issue:["string","number"],jurisdiction:"string",keyword:"string",locator:"string",medium:"string",note:"string",number:["string","number"],"number-of-pages":"string","number-of-volumes":["string","number"],"original-publisher":"string","original-publisher-place":"string","original-title":"string",page:"string","page-first":"string","part-number":["string","number"],"part-title":"string",PMCID:"string",PMID:"string",printing:"string",publisher:"string","publisher-place":"string",references:"string","reviewed-title":"string","reviewed-genre":"string",scale:"string",section:"string",source:"string",status:"string",supplement:["string","number"],title:"string","title-short":"string",URL:"string",version:"string",volume:["string","number"],"volume-title":"string","volume-title-short":"string","year-suffix":"string"};function Vi(e,t){if(typeof e=="object"&&e!==null&&(e.literal||e.given||e.family))return(e.ORCID||e.orcid||e._ORCID)&&(e=Jt({_orcid:e.ORCID||e.orcid||e._ORCID},e),delete e.ORCID,delete e.orcid,delete e._ORCID),e;if(t){if(typeof e=="string")return(0,qi.parse)(e)}else return}function La(e,t){if(e instanceof Array){let i=e.map(r=>Vi(r,t)).filter(Boolean);return i.length?i:void 0}}function Ht(e,t){return e.every(i=>typeof i=="number")?e:!t||e.some(i=>isNaN(parseInt(i)))?void 0:e.map(i=>parseInt(i))}function Ma(e,t){let i="date-parts";if(!(typeof e!="object"||e===null)){if(e[i]instanceof Array&&e[i].every(r=>r instanceof Array)){let r=e[i].map(s=>Ht(s,t)).filter(Boolean);return r.length?Jt(Jt({},e),{},{"date-parts":r}):void 0}else if(e instanceof Array&&e.every(r=>r[i]instanceof Array)){let r=e.map(s=>Ht(s[i],t)).filter(Boolean);return r.length?{"date-parts":r}:void 0}else if(e[i]instanceof Array){let r=Ht(e[i],t);return r&&{"date-parts":[r]}}else if("literal"in e||"raw"in e)return e}}function Xi(e,t){if(e=Wt("language",e,t),$t[e]===!0)return e;if(t){if(e in $t)return $t[e];if(typeof e=="string"&&e.toLowerCase()!==e)return Xi(e.toLowerCase(),t)}}function Wt(e,t,i){let r=[].concat(ji[e]);switch(ji[e]){case za:return Vi(t,i);case Z:return La(t,i);case _e:return Ma(t,i);case Gi:return Xi(t,i)}if(i){if(typeof t=="string"&&r.includes("number")&&!r.includes("string")&&!isNaN(+t))return parseFloat(t);if(typeof t=="number"&&r.includes("string")&&!r.includes("number"))return t.toString();if(Array.isArray(t)&&t.length)return Wt(e,t[0],i)}if(r.includes(typeof t))return t}function Qt(e,t=!0){return e.map(function(i){let r={};for(let s in i){let o=Wt(s,i[s],t);o!==void 0&&(r[s]=o)}return r})}var Me={},Pe={},Kt={"@csl/object":e=>[e],"@csl/list+object":e=>e,"@else/list+object":e=>e.map(t=>{let i=ue(t);return Be(t,i)}).flat(),"@invalid":()=>{throw new Error("This format is not supported or recognized")}},Zt={"@else/list+object":e=>Promise.all(e.map(t=>{let i=ue(t);return Je(t,i)})).then(t=>t.flat())};function Be(e,t){if(typeof Me[t]=="function")return Me[t](e);if(typeof Kt[t]=="function")return Kt[t](e);throw new TypeError(`No synchronous parser found for ${t}`)}async function Je(e,t){if(typeof Pe[t]=="function")return Pe[t](e);if(typeof Zt[t]=="function")return Zt[t](e);if($i(t,!1))return Be(e,t);throw new TypeError(`No parser found for ${t}`)}function lt(e,{parser:t,async:i}){i?Pe[e]=t:Me[e]=t}function $i(e,t){return t?Pe[e]||Zt[e]:Me[e]||Kt[e]}function mt(e,t){delete(t?Pe:Me)[e]}function Pa(e){return Object.keys(e?Pe:Me)}var Ce={};function Ba(e,t){let i=new He(e,t);i.validate();let r=Ce[e]||(Ce[e]={});i.typeParser&&(Mt(e,i.typeParser),r.type=!0),i.dataParser&&(lt(e,i.dataParser),r.data=!0),i.asyncDataParser&&(lt(e,i.asyncDataParser),r.asyncData=!0),t.outputs&&(r.outputs=t.outputs)}function ei(e){return Ce[e]}function Fa(e){let t=Ce[e];t&&(t.type&&Pt(e),t.data&&mt(e),t.asyncData&&mt(e,!0),delete Ce[e])}function Ua(e){return e in Ce}function ja(){return Object.keys(Ce)}var ce={};se(ce,{Grammar:()=>dt,Register:()=>Ue,TokenStack:()=>sr,Translator:()=>ke,deepCopy:()=>we,downgradeCsl:()=>Fe,fetchFile:()=>ir,fetchFileAsync:()=>rr,fetchId:()=>Ye,setUserAgent:()=>ar,upgradeCsl:()=>We});function Hi(e,t){var i=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(s){return Object.getOwnPropertyDescriptor(e,s).enumerable})),i.push.apply(i,r)}return i}function Ji(e){for(var t=1;t<arguments.length;t++){var i=arguments[t]!=null?arguments[t]:{};t%2?Hi(Object(i),!0).forEach(function(r){qa(e,r,i[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(i)):Hi(Object(i)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(i,r))})}return e}function qa(e,t,i){return(t=Ga(t))in e?Object.defineProperty(e,t,{value:i,enumerable:!0,configurable:!0,writable:!0}):e[t]=i,e}function Ga(e){var t=Va(e,"string");return typeof t=="symbol"?t:t+""}function Va(e,t){if(typeof e!="object"||!e)return e;var i=e[Symbol.toPrimitive];if(i!==void 0){var r=i.call(e,t||"default");if(typeof r!="object")return r;throw new TypeError("@@toPrimitive must return a primitive value.")}return(t==="string"?String:Number)(e)}function We(e){return Array.isArray(e)?e.map(We):(e=Ji({},e),"event"in e&&(e["event-title"]=e.event,delete e.event),e.type==="book"&&"version"in e&&(e.type="software"),e)}function Fe(e){return Array.isArray(e)?e.map(Fe):(e=Ji({},e),"event-title"in e&&(e.event=e["event-title"],delete e["event-title"]),e.type==="software"&&(e.type="book"),e)}function Qe(e,t=new Set){if(typeof e!="object"||e===null||e.constructor!==Object&&e.constructor!==Array)return e;if(t.has(e))throw new TypeError("Recursively copying circular structure");t.add(e);let i;if(e.constructor===Array)i=e.map(r=>Qe(r,t));else{let r={};for(let s in e)r[s]=Qe(e[s],t);i=r}return t.delete(e),i}var we=Qe;var si=at(Qi());var Wa=typeof globalThis.fetch=="function"?globalThis.fetch.bind(globalThis):()=>Promise.reject(new Error("fetch is not available")),Yi=Wa,Ki=globalThis.Headers,Xo=globalThis.Request,$o=globalThis.Response,Ho=globalThis.FormData,Jo=globalThis.Blob;var ft={name:"@citation-js/core",version:"0.8.2",description:"Convert different bibliographic metadata sources",keywords:["citation-js","citation","bibliography"],author:"Lars Willighagen <lars.willighagen@gmail.com>",license:"MIT",main:"lib/index.js",module:"lib-mjs/index.js",directories:{lib:"src",test:"__tests__"},homepage:"https://citation.js.org/",repository:{type:"git",url:"https://github.com/citation-js/citation-js.git",directory:"packages/core"},bugs:{url:"https://github.com/citation-js/citation-js/issues"},engines:{node:">=20.19.0"},files:["lib","lib-mjs"],scripts:{test:"mocha -c -R dot -r @babel/register test/*.spec.js","test:live":"TEST_MOCK_HTTP=false npm test",coverage:"NODE_ENV=coverage nyc npm test -- -c && nyc report --reporter=text-lcov > coverage.lcov"},dependencies:{"@citation-js/date":"^0.5.0","@citation-js/name":"^0.4.2","node-fetch":"^3.3.2","sync-fetch":"^0.6.0"},gitHead:"28ce00a6a5dd967baeb7f128f3f6b4a7217e5d46"};var oi=typeof location<"u"&&typeof navigator<"u",Ya=oi?fetch:Yi,Ka=oi?Headers:Ki,ht=`Citation.js/${ft.version}`;typeof process<"u"&&process&&process.release&&process.release.name==="node"&&process.version&&(ht+=` Node.js/${process.version}`);function Zi(e){let t={},i=e instanceof Ka||e instanceof si.default.Headers?Array.from(e):Object.entries(e);for(let[r,s]of i)t[r.toLowerCase()]=s.toString();return t}function er(e={}){let t={headers:{accept:"*/*"},method:"GET",checkContentType:e.checkContentType};if(ht&&!oi&&(t.headers["user-agent"]=ht),e.body){t.method="POST";let i=typeof e.body!="string";t.body=i?JSON.stringify(e.body):e.body,t.headers["content-type"]=i?"application/json":"text/plain"}return e.headers&&Object.assign(t.headers,Zi(e.headers)),t}function Za(e,t){if(!e.accept||e.accept==="*/*"||!t["content-type"])return!0;let[i,r]=t["content-type"].split(";")[0].trim().split("/");return e.accept.split(",").map(s=>s.split(";")[0].trim().split("/")).some(([s,o])=>(s===i||s==="*")&&(o===r||o==="*"))}function tr(e,t){let{status:i,headers:r}=e,s;if(i>=400?s=new Error(`Server responded with status code ${i}`):t.checkContentType===!0&&!Za(t.headers,Zi(r))&&(s=new Error(`Server responded with content-type ${r.get("content-type")}`)),s)throw s.status=i,s.headers=r,s.body=e.body,s;return e}function ir(e,t){let i=er(t);return le.http("[core]",i.method,e,i),tr((0,si.default)(e,i),i).text()}async function rr(e,t){let i=er(t);return le.http("[core]",i.method,e,i),Ya(e,i).then(r=>tr(r,i)).then(r=>r.text())}function ar(e){ht=e}function es(e,t){let i;for(;i===void 0||e.includes(i);)i=`${t}${Math.random().toString().slice(2)}`;return i}var Ye=es;var ni=class e{constructor(t){this.stack=t,this.index=0,this.current=this.stack[this.index]}static getPatternText(t){return`"${t instanceof RegExp?t.source:t}"`}static getMatchCallback(t){if(Array.isArray(t)){let i=t.map(e.getMatchCallback);return r=>i.some(s=>s(r))}else return t instanceof Function?t:t instanceof RegExp?i=>t.test(i):i=>t===i}tokensLeft(){return this.stack.length-this.index}matches(t){return e.getMatchCallback(t)(this.current,this.index,this.stack)}matchesSequence(t){let i=this.stack.slice(this.index,this.index+t.length).join("");return typeof t=="string"?i===t:t.every((r,s)=>e.getMatchCallback(r)(i[s]))}consumeToken(t=/^[\s\S]$/,{inverse:i=!1,spaced:r=!0}={}){r&&this.consumeWhitespace();let s=this.current;if(e.getMatchCallback(t)(s,this.index,this.stack))this.current=this.stack[++this.index];else throw new SyntaxError(`Unexpected token at index ${this.index}: Expected ${e.getPatternText(t)}, got "${s}"`);return r&&this.consumeWhitespace(),s}consumeWhitespace(t=/^\s$/,{optional:i=!0}={}){return this.consume(t,{min:+!i})}consumeN(t){if(this.tokensLeft()<t)throw new SyntaxError("Not enough tokens left");let i=this.index;for(;t--;)this.current=this.stack[++this.index];return this.stack.slice(i,this.index).join("")}consumeSequence(t){if(this.matchesSequence(t))return this.consumeN(t.length);throw new SyntaxError(`Expected "${t}", got "${this.consumeN(t.length)}"`)}consume(t=/^[\s\S]$/,{min:i=0,max:r=1/0,inverse:s=!1,tokenMap:o,tokenFilter:n}={}){let l=this.index,m=e.getMatchCallback(t);for(;m(this.current,this.index,this.stack)!==s;)this.current=this.stack[++this.index];let u=this.stack.slice(l,this.index);if(u.length<i)throw new SyntaxError(`Not enough ${e.getPatternText(t)}`);if(u.length>r)throw new SyntaxError(`Too many ${e.getPatternText(t)}`);return o&&(u=u.map(o)),n&&(u=u.filter(n)),u.join("")}},sr=ni;var li=class{constructor(t={}){this.data=t}set(t,i){return this.data[t]=i,this}add(...t){return this.set(...t)}delete(t){return delete this.data[t],this}remove(...t){return this.delete(...t)}get(t){return this.data[t]}has(t){return Object.prototype.hasOwnProperty.call(this.data,t)}list(){return Object.keys(this.data)}},Ue=li;var dt=class{constructor(t,i){this.rules=t,this.defaultState=i,this.mainRule=Object.keys(t)[0],this.log=[]}parse(t,i){return this.lexer=t,this.token=this.lexer.next(),this.state=Qe(this.defaultState),this.log=[],this.consumeRule(i||this.mainRule)}matchEndOfFile(){return!this.token}matchToken(t){return this.token&&t===this.token.type}consumeToken(t,i){let r=this.token;if(!t||r&&r.type===t)return this.token=this.lexer.next(),r;if(i)return;{let s=r?`"${r.type}"`:"EOF",o=new SyntaxError(this.lexer.formatError(r,`expected "${t}", got ${s}`));throw o.message+=` (${this.log.join("->")})`,o}}consumeRule(t){this.log.push(t);let i=this.rules[t].call(this);return this.log.pop(),i}};function ts(e){return function(i){return typeof e=="boolean"?e:Object.keys(e).every(r=>{let s=e[r];return s===!0?r in i:s===!1?!(r in i):typeof s=="function"?s(i[r]):Array.isArray(s)?s.includes(i[r]):i[r]===s})}}function is(e,t){let i,r,s,o;if(typeof e=="string")i=r=e;else if(e)i=t?e.target:e.source,r=t?e.source:e.target,e.convert&&(s=t?e.convert.toSource:e.convert.toTarget),e.when&&(o=t?e.when.target:e.when.source,o!=null&&(o=ts(o)));else return null;return i=[].concat(i).filter(Boolean),r=[].concat(r).filter(Boolean),{inputProp:i,outputProp:r,convert:s,condition:o}}function or(e,t){return t=t===ke.CONVERT_TO_SOURCE,e=e.map(i=>is(i,t)).filter(Boolean),function(r){let s={};for(let{inputProp:o,outputProp:n,convert:l,condition:m}of e){if(n.length===0)continue;if(m&&!m(r))continue;if(o.length!==0&&o.every(p=>!(p in r)))continue;let u=o.map(p=>r[p]);if(l)try{let p=l.apply(r,u);u=n.length===1?[p]:p}catch(p){throw new Error(`Failed to convert ${o} to ${n}`,{cause:p})}n.forEach((p,f)=>{let c=u[f];c!==void 0&&(s[p]=c)})}return s}}var ke=class e{constructor(t){this.convertToSource=or(t,e.CONVERT_TO_SOURCE),this.convertToTarget=or(t,e.CONVERT_TO_TARGET)}};ke.CONVERT_TO_SOURCE=Symbol("convert to source");ke.CONVERT_TO_TARGET=Symbol("convert to target");function rs(e){return e.reduce((t,i)=>{let r=t[t.length-1];return r&&r.type===i.type?r.count=r.count+1||2:t.push(i),t},[]).map(t=>(t.count>1?t.count+"x ":"")+t.type).join(" -> ")}var gt=class{constructor(t,i={}){this.options=Object.assign({generateGraph:!0,forceType:ue(t),maxChainLength:10,strict:!0,target:"@csl/list+object"},i),this.type=this.options.forceType,this.data=typeof t=="object"?we(t):t,this.graph=[{type:this.type,data:t}],this.iteration=0}iterate(){if(this.iteration!==0){let t=ei(this.type);t&&t.outputs?this.type=t.outputs:this.type=ue(this.data),this.graph.push({type:this.type})}return this.error||this.type===this.options.target?!1:this.iteration>=this.options.maxChainLength?(this.error=new RangeError(`Max. number of parsing iterations reached (${rs(this.graph)})`),!1):(this.iteration++,!0)}end(){if(this.error){if(le.error("[core]",this.error.message),this.options.strict!==!1)throw this.error;return[]}else return this.options.target==="@csl/list+object"?We(this.data).map(this.options.generateGraph?t=>It(t,this.graph):zt):this.data}},mi=(...e)=>{let t=new gt(...e);for(;t.iterate();)try{t.data=Be(t.data,t.type)}catch(i){t.error=i}return t.end()},as=e=>{let t=ue(e),i=t.match(/array|object/)?we(e):e;return Be(i,t)},ui=async(...e)=>{let t=new gt(...e);for(;t.iterate();)t.data=await Je(t.data,t.type).catch(i=>{t.error=i});return t.end()},ss=async e=>{let t=ue(e),i=t.match(/array|object/)?we(e):e;return Je(i,t)};var os=Object.assign({},Rt,Lt,Ft,Yt);function ns(e,t={},i=!1){return(t===!0||i===!0)&&this.save(),this.data.push(...mi(e,t)),this.data.filter(r=>!Object.prototype.hasOwnProperty.call(r,"id")).forEach(r=>{r.id=Ye(this.getIds(),"temp_id_")}),this}async function ls(e,t={},i=!1){return(t===!0||i===!0)&&this.save(),this.data.push(...await ui(e,t)),this.data.filter(r=>!Object.prototype.hasOwnProperty.call(r,"id")).forEach(r=>{r.id=Ye(this.getIds(),"temp_id_")}),this}function ms(e,t={},i=!1){return(t===!0||i===!0)&&this.save(),this.data=[],typeof t!="boolean"?this.add(e,t):this.add(e)}async function us(e,t={},i=!1){return(t===!0||i===!0)&&this.save(),this.data=[],typeof t!="boolean"?this.addAsync(e,t):this.addAsync(e)}function cs(e){return e&&this.save(),this.data=[],this._options={},this}var fi={};se(fi,{sort:()=>hs});function pi(e){if("citation-label"in e)return e["citation-label"];let t="";return e.author&&(t+=e.author[0].family||e.author[0].literal),e.issued&&e.issued["date-parts"]&&e.issued["date-parts"][0]&&(t+=e.issued["date-parts"][0][0]),e["year-suffix"]?t+=e["year-suffix"]:e.title&&(t+=e.title.replace(/<\/?.*?>/g,"").match(/^(?:(?:the|a|an)\s+)?(\S+)/i)[1]),t}var nr={label(e){return e.reduce((t,i)=>(t[i.id]=pi(i),t),{})}};var mr=at(Xt());function lr(e,t,i=t==="label"){let r=i?pi(e):e[t];switch(t){case"author":case"editor":return r.map(s=>s.literal||s.family||(0,mr.format)(s));case"accessed":case"issued":return r["date-parts"][0];case"page":return r.split("-").map(s=>parseInt(s));case"edition":case"issue":case"volume":return r=parseInt(r),isNaN(r)?-1/0:r;default:return r||-1/0}}function ps(e,t,i,r=/^!/.test(i)){i=i.replace(/^!/,"");let s=lr(e,i),o=lr(t,i);return(r?-1:1)*(s>o?1:s<o?-1:0)}function fs(...e){return(t,i)=>{let r=e.slice(),s=0;for(;!s&&r.length;)s=ps(t,i,r.shift());return s}}function hs(e=[],t){return t&&this.save(),this.data.sort(typeof e=="function"?e:fs(...e,"label")),this}var di={};se(di,{format:()=>_s,get:()=>ws,getIds:()=>xs});var vt={};se(vt,{add:()=>gs,format:()=>hi,has:()=>vs,list:()=>ys,register:()=>De,remove:()=>bs});function ds(e,t){if(typeof e!="string")throw new TypeError(`Invalid output format name, expected string, got ${typeof e}`);if(typeof t!="function")throw new TypeError(`Invalid formatter, expected function, got ${typeof t}`)}var De=new Ue;function gs(e,t){ds(e,t),De.set(e,t)}function bs(e){De.remove(e)}function vs(e){return De.has(e)}function ys(){return De.list()}function hi(e,t,...i){if(!De.has(e))throw new Error(`Output format "${e}" unavailable`);return De.get(e)(t,...i)}function xs(){return this.data.map(e=>e.id)}function _s(e,...t){return hi(e,Qt(this.data),...t)}function ws(e={}){Ie(e);let t=Object.assign({},this.defaultOptions,this._options.output,e),{type:i,style:r}=t,[s,o]=r.split("-"),n=s==="citation"?"bibliography":s==="csl"?"data":s,l=i==="string"?"text":i==="json"?"object":i,m;switch(n){case"bibliography":{let{lang:f,append:c,prepend:d}=t;m={template:o,lang:f,format:l,append:c,prepend:d};break}case"data":case"bibtex":case"bibtxt":case"ndjson":case"ris":m={type:l};break;default:throw new Error(`Invalid style "${n}"`)}let u=this.format(n,Object.assign(m,e._newOptions)),{format:p}=t;if(p==="real"&&l==="html"&&typeof document<"u"&&typeof document.createElement=="function"){let f=document.createElement("div");return f.innerHTML=u,f.firstChild}else return p==="string"&&typeof u=="object"?JSON.stringify(u):u}var gi={};se(gi,{async:()=>ur,validateOptions:()=>ra,validateOutputOptions:()=>Ie});function As(e,t,i){typeof t=="function"&&!i&&(i=t,t=void 0);let r=new this().setAsync(e,t);if(typeof i=="function"){r.then(i);return}else return r}var ur=As;function Ke(e,t={}){return this instanceof Ke?(this._options=t,this.log=[],this.data=[],this.set(e,t),this.options(t),this):new Ke(e,t)}Object.assign(Ke.prototype,Ct,kt,ci,fi,di);Ke.prototype[Symbol.iterator]=function*(){yield*this.data};Object.assign(Ke,gi);var ve={};se(ve,{add:()=>vi,config:()=>yt,dict:()=>je,has:()=>Ms,input:()=>bt,list:()=>Ps,output:()=>vt,remove:()=>Ls});var je={};se(je,{add:()=>Es,get:()=>ks,has:()=>Ts,list:()=>Cs,register:()=>Ne,remove:()=>Ss});function Os(e,t){if(typeof e!="string")throw new TypeError(`Invalid dict name, expected string, got ${typeof e}`);if(typeof t!="object")throw new TypeError(`Invalid dict, expected object, got ${typeof t}`);for(let i in t){let r=t[i];if(!Array.isArray(r)||r.some(s=>typeof s!="string"))throw new TypeError(`Invalid dict entry "${i}", expected array of strings`)}}var Ne=new Ue({html:{bibliographyContainer:['<div class="csl-bib-body">',"</div>"],entry:['<div class="csl-entry">',"</div>"],list:['<ul style="list-style-type:none">',"</ul>"],listItem:["<li>","</li>"]},text:{bibliographyContainer:["",`
`],entry:["",`
`],list:[`
`,""],listItem:["	",`
`]}});function Es(e,t){Os(e,t),Ne.set(e,t)}function Ss(e){Ne.remove(e)}function Ts(e){return Ne.has(e)}function Cs(){return Ne.list()}function ks(e){if(!Ne.has(e))throw new Error(`Dict "${e}" unavailable`);return Ne.get(e)}var yt={};se(yt,{add:()=>Ds,get:()=>Ns,has:()=>Rs,list:()=>zs,remove:()=>Is});var Ze={};function Ds(e,t){Ze[e]=t}function Ns(e){return Ze[e]}function Rs(e){return Object.prototype.hasOwnProperty.call(Ze,e)}function Is(e){delete Ze[e]}function zs(){return Object.keys(Ze)}var bi={input:bt,output:vt,dict:je,config:yt},et={};function vi(e,t={}){let i=et[e]={};for(let r in t){if(r==="config"){i.config={[e]:t.config},bi.config.add(e,t.config);continue}let s=i[r]={},o=t[r];for(let n in o){let l=o[n];s[n]=!0,bi[r].add(n,l)}}}function Ls(e){let t=et[e];for(let i in t){let r=t[i];for(let s in r)bi[i].remove(s)}delete et[e]}function Ms(e){return e in et}function Ps(){return Object.keys(et)}function xt(){return[]}var Fs=[[/((?:\[|:|,)\s*)'((?:\\'|[^'])*?[^\\])?'(?=\s*(?:\]|}|,))/g,'$1"$2"'],[/((?:(?:"|]|}|\/[gmiuys]|\.|(?:\d|\.|-)*\d)\s*,|{)\s*)(?:"([^":\n]+?)"|'([^":\n]+?)'|([^":\n]+?))(\s*):/g,'$1"$2$3$4"$5:']];function cr(e){if(typeof e!="string")return JSON.parse(e);try{return JSON.parse(e)}catch{return le.debug("[plugin-common]","Invalid JSON, switching to experimental parser"),Fs.forEach(([i,r])=>{e=e.replace(i,r)}),JSON.parse(e)}}function pr(e){return e.val()||e.text()||e.html()}function fr(e){return e.value||e.textContent}var hr="@else";var dr={"@empty/text":{parse:xt,parseType:{dataType:"String",predicate:e=>e===""}},"@empty/whitespace+text":{parse:xt,parseType:{dataType:"String",predicate:/^\s+$/}},"@empty":{parse:xt,parseType:{dataType:"Primitive",predicate:e=>e==null}},"@else/json":{parse:cr,parseType:{dataType:"String",predicate:/^\s*(\{[\S\s]*\}|\[[\S\s]*\])\s*$/}},"@else/url":{parseType:{dataType:"String",predicate:/^https?:\/\/(([\w-]+\.)*[\w-]+)(:\d+)?(\/[^?/]*)*(\?[^#]*)?(#.*)?$/i}},"@else/jquery":{parse:pr,parseType:{dataType:"ComplexObject",predicate(e){return typeof jQuery<"u"&&e instanceof jQuery}}},"@else/html":{parse:fr,parseType:{dataType:"ComplexObject",predicate(e){return typeof HTMLElement<"u"&&e instanceof HTMLElement}}}};function br(e,t,i){return e+(t<i.length-1?",":"")}function vr(e,t){let i=Array.isArray(e),r;return i?r=e.map(s=>gr(s,t)):r=Object.keys(e).filter(s=>JSON.stringify(e[s])).map(s=>`"${s}": ${gr(e[s],t)}`),r=r.map(br).map(s=>t.listItem.join(s)),r=t.list.join(r.join("")),i?`[${r}]`:`{${r}}`}function gr(e,t){return typeof e=="object"&&e!==null?e.length===0?"[]":Object.keys(e).length===0?"{}":vr(e,t):JSON.stringify(e)}function Gs(e,t){let i=e.map(r=>vr(r,t));return i=i.map(br).map(r=>t.entry.join(r)),i=i.join(""),t.bibliographyContainer.join(`[${i}]`)}var yr={data(e,{type:t,format:i=t||"text",version:r="1.0.2"}={}){return r<"1.0.2"&&(e=Fe(e)),i==="object"?we(e):i==="text"?JSON.stringify(e,null,2):(le.warn("[core]","This feature (JSON output with special formatting) is unstable. See https://github.com/larsgw/citation.js/issues/144"),Gs(e,je.get(i)))},ndjson(e,{version:t="1.0.2"}={}){return t<"1.0.2"&&(e=Fe(e)),e.map(i=>JSON.stringify(i)).join(`
`)}};var xr=Object.assign({},yr,nr);vi(hr,{input:dr,output:xr});var el=ft.version;var _r={"en-US":`<?xml version="1.0" encoding="utf-8"?>
...
`};var tt=new ce.Register(wr);var Oe=at(Or());var Er=Symbol.for("proxied"),$s=function(e){let t=function(i,r){if(i.sys.wrapBibliographyEntry){let[s,o]=i.sys.wrapBibliographyEntry(this.system_id);r=[s,r,o].join("")}return e.call(this,i,r)};return t[Er]=!0,t};for(let e in Oe.default.Output.Formats){let t=Oe.default.Output.Formats[e]["@bibliography/entry"];!t||t[Er]||(Oe.default.Output.Formats[e]["@bibliography/entry"]=$s(t))}function Hs(e){if(Ae.has(e))return Ae.get(e);let t=e.replace("-","_");return Ae.has(t)?Ae.get(t):{}}var yi={},Js=function(e,t,i,r,s){let o=`${e}|${t}`,n;return yi[o]instanceof Oe.default.Engine?(n=yi[o],n.sys.retrieveItem=r,n.sys.wrapBibliographyEntry=void 0,n.updateItems([])):n=yi[o]=new Oe.default.Engine({retrieveLocale:s,retrieveItem:r},i,t,!0),n},Ws=function(e,t,i,r){if(!Oe.default.Output.Formats[r]||!Oe.default.Output.Formats[r]["@bibliography/entry"])throw new TypeError(`Cannot find format '${r}'`);if(!tt.has(t))throw new TypeError(`Cannot find style '${t}'`);let s=e.reduce((l,m)=>(l[m.id]=m,l),{});i=Ae.has(i)?i:void 0;let o=function(l){if(Object.prototype.hasOwnProperty.call(s,l))return s[l];throw new Error(`Cannot find entry with id '${l}'`)},n=Js(t,i,tt.get(t),o,Hs);return n.setOutputFormat(r),n.opt.development_extensions.wrap_url_and_doi=!1,n},qe=Ws;var Qs=(e,t,i)=>e.replace(/^\s*<[a-z]+/i,`$& data-${t}="${i}"`),Sr=(e,t)=>Qs(e,"csl-entry-id",t);var Tr=(e,t)=>typeof t=="function"?t(e):t||"";function xi(e,t={}){let i=t.style||t.template||"apa",{lang:r,format:s="text",nosort:o=!1}=t,n=t.entry?[].concat(t.entry):e.map(({id:b})=>b);t.downgradeCsl&&(e=ce.downgradeCsl(e));let l=qe(e,i,r,s),m=l.updateItems(n,o);if(t.append||t.prepend){let b=e.reduce((h,_)=>(h[_.id]=_,h),{});l.sys.wrapBibliographyEntry=function(h){let _=b[h];return[Tr(_,t.prepend),Tr(_,t.append)]}}t.hyperlinks&&(l.opt.development_extensions.wrap_url_and_doi=!0);let u=l.makeBibliography(),[{bibstart:p,bibend:f},c]=u,d=c.map((b,h)=>Sr(b,m[h]));return t.asEntryArray?d.map((b,h)=>[m[h],b]):p+d.join("")+f}function Ys(e){return typeof e=="object"?e:{id:e}}function kr(e){return e.citationItems?e:{citationItems:[].concat(e).map(Ys),properties:{noteIndex:0}}}function Cr(e){return e?e.map(kr):[]}function _i(e,t={}){let i=t.style||t.template||"apa",{lang:r,format:s="text"}=t,o=e.map(({id:c})=>c),n=t.entry?t.entry:o;t.downgradeCsl&&(e=ce.downgradeCsl(e));let l=qe(e,i,r,s),m=Cr(t.citationsPre),u=kr(n),p=Cr(t.citationsPost);return l.rebuildProcessorState([...m,u,...p],s,[])[m.length][2]}ve.add("@csl",{output:{bibliography:xi,citation:_i},config:{engine:qe,locales:Ae,styles:tt}});var Dr=`<?xml version="1.0" encoding="utf-8"?>
...
`;var Nr=`<?xml version="1.0" encoding="utf-8"?>
...
`;var Ir=`<?xml version="1.0" encoding="utf-8"?>
...
`;var Mr="https://items-lottery-obligations-transparency.trycloudflare.com/api/v1/reference",io="libretexts-references:",ro=_o(window.location.hostname),ao={ieee:Dr,"american-medical-association":Nr,"modern-language-association":Rr,"chicago-author-date":Ir},zr=new Set(["apa","vancouver","harvard1"]),Lr={IEEE:{cslStyle:"ieee",heading:"References",listType:"ul",superscript:!0},Vancouver:{cslStyle:"vancouver",heading:"References",listType:"ul",superscript:!1},AMA:{cslStyle:"american-medical-association",heading:"References",listType:"ul",superscript:!0},CSM:{cslStyle:"ieee",heading:"References",listType:"ul",superscript:!0},ASN:{cslStyle:"american-medical-association",heading:"References",listType:"ul",superscript:!0},ANSI:{cslStyle:"ieee",heading:"References",listType:"ul",superscript:!0},APA:{cslStyle:"apa",heading:"References",listType:"ul",superscript:!1},MLA:{cslStyle:"modern-language-association",heading:"Works Cited",listType:"ul",superscript:!1},Chicago:{cslStyle:"chicago-author-date",heading:"References",listType:"ul",superscript:!1},Harvard:{cslStyle:"harvard1",heading:"Reference List",listType:"ul",superscript:!1}},so={article:"article-journal",incollection:"chapter",book:"book",inproceedings:"paper-conference",proceedings:"book",techreport:"report",thesis:"thesis",mastersthesis:"thesis",phdthesis:"thesis",misc:"document",online:"webpage",electronic:"webpage",unpublished:"manuscript"};document.addEventListener("DOMContentLoaded",async()=>{let e=document.getElementById("pageID")?.value;if(!e){console.error("pageID not found");return}try{let t=await Pr(`${Mr}/page/${e}/library/${ro}`),{projectID:i,lastUpdatedAt:r,format:s,displayLocation:o,pageTitle:n}=t,l=await mo(i,r),m=wo(s);uo(m.cslStyle);let u=l.map(yo),p=co(u,m.cslStyle),{allInstances:f,nodeMap:c}=fo(document.body);if(f.length===0)return;let d=po(p,f);go(c,d,m),vo(p,m,o)}catch(t){console.error("Failed to load citations:",t)}});async function Pr(e){let t=await fetch(e);if(!t.ok)throw new Error(`HTTP ${t.status} for ${e}`);let i=await t.json();if(i.err)throw new Error(`API error for ${e}`);return i.data}function Br(e){return`${io}${e}`}function oo(e){let t=localStorage.getItem(Br(e));return t?JSON.parse(t):null}function no(e,t,i){localStorage.setItem(Br(e),JSON.stringify({lastUpdatedAt:t,referenceItems:i}))}function lo(e,t){return!!(e?.lastUpdatedAt&&e.referenceItems&&new Date(e.lastUpdatedAt)>=new Date(t))}async function mo(e,t){let i=oo(e);if(lo(i,t))return i.referenceItems;let r=await Pr(`${Mr}/projects/${e}`);return no(e,t,r.referenceItems),r.referenceItems}function uo(e){if(zr.has(e))return;let t=ao[e];if(!t)throw new Error(`CSL style "${e}" is not bundled. Add it to src/csl/.`);ve.config.get("@csl").styles.add(e,t),zr.add(e)}function co(e,t){return ve.config.get("@csl").engine(e,t,"en-US","html")}function po(e,t){let i=[...new Set(t.flatMap(o=>o.keys))];e.updateItems(i);let r=new Array(t.length).fill("?"),s=[];for(let o=0;o<t.length;o++){let n=`cite-${o}`,l={citationID:n,citationItems:t[o].keys.map(u=>({id:u})),properties:{noteIndex:0}},[,m=[]]=e.processCitationCluster(l,s,[]);for(let u of m){let[,p,f]=Array.isArray(u)?u:[];if(typeof f=="string"){let c=parseInt(f.replace("cite-",""),10);c>=0&&c<t.length&&(r[c]=p??"?")}}s.push([n,0])}return r}function fo(e){let t=[],i=new Map,r=document.createTreeWalker(e,NodeFilter.SHOW_TEXT);for(let s=r.nextNode();s;s=r.nextNode()){let o=s.textContent;if(!o.includes("\\librecite{"))continue;let n=[];i.set(s,n);for(let l of o.matchAll(/\\librecite\{([^}]+)\}/g)){let m=t.length,u=ho(l[1]);t.push({keys:u}),n.push({keys:u,matchIndex:l.index,matchLen:l[0].length,instanceIndex:m})}}return{allInstances:t,nodeMap:i}}function ho(e){return e.split(",").map(t=>t.trim()).filter(Boolean)}function go(e,t,i){for(let[r,s]of e)bo(r,s,t,i)}function bo(e,t,i,r){let s=e.textContent,o=document.createDocumentFragment(),n=0;for(let{keys:l,matchIndex:m,matchLen:u,instanceIndex:p}of t){m>n&&o.appendChild(document.createTextNode(s.slice(n,m)));let f=i[p]??"?",c=f.includes("<sup"),d=r.superscript&&!c?"sup":"span",b=document.createElement(d);b.className="librecite",b.dataset.citationKeys=l.join(","),b.innerHTML=f,b.addEventListener("click",()=>{for(let h of l){let _=document.getElementById(`ref-${h}`);if(_){_.scrollIntoView({behavior:"smooth"});break}}}),o.appendChild(b),n=m+u}n<s.length&&o.appendChild(document.createTextNode(s.slice(n))),e.parentNode.replaceChild(o,e)}function vo(e,t,i){let[r,s]=e.makeBibliography();if(!s?.length)return;let o=r.entry_ids??[],n=document.getElementById("reference-output");if(!n){let m=document.createElement("section");m.id="references";let u=document.createElement("h2");u.textContent=t.heading,m.appendChild(u),document.body.appendChild(m),n=m}i!=="endOfPage"&&(n.style.display="none");let l=document.createElement(t.listType);l.className="references-list",s.forEach((m,u)=>{let p=o[u]?.[0],f=document.createElement("li");p&&(f.id=`ref-${p}`);let c=document.createElement("div");c.innerHTML=m;let d=c.querySelector(".csl-entry");f.innerHTML=d?d.innerHTML:m,l.appendChild(f)}),n.appendChild(l)}function yo(e){return{id:e.citationKey,type:so[e.entryType?.toLowerCase()]??"document",title:e.title??"Untitled",author:xo(e.author),issued:e.year?{"date-parts":[[Number(e.year)]]}:void 0,"container-title":e.journal??e.booktitle??void 0,volume:e.volume??void 0,issue:e.number??void 0,page:e.pages?.replace(/--/g,"-")??void 0,URL:e.url??void 0,publisher:e.publisher??void 0,note:e.note??void 0}}function xo(e){return e?e.split(/\s+and\s+/i).map(t=>t.trim()).filter(Boolean).map(t=>{if(t.includes(",")){let r=t.indexOf(",");return{family:t.slice(0,r).trim(),given:t.slice(r+1).trim()}}let i=t.split(/\s+/);return{family:i[i.length-1],given:i.slice(0,-1).join(" ")}}):[]}function _o(e){return e.includes("localhost")||e.includes("127.0.0.1")?"dev":e.split(".")[0]?.toLowerCase()??"dev"}function wo(e){return Lr[e]??Lr.IEEE}function Ao(e){return"gt-anchor-"+String(e).toLowerCase().trim().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}function Oo(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;")}globalThis.termAnchorId=Ao;globalThis.escapeHtml=Oo;})();
